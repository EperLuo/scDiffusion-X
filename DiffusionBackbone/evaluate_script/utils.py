...
from model import VQModel, UNet2DConditionModel
...
def load_pipline(args,unet_path):
    ...
    with ContextManagers(deepspeed_zero_init_disabled_context_manager()):
        ...
        vae = VQModel.from_pretrained(
            args.pretrained_vae_path, revision=args.revision, variant=args.variant
        )
    ...
    return pipeline, vae, accelerator, weight_dtype
