...
--weight_decay 0.0001  --norm_type layernorm
...
--devices 2,3 --log_interval 100 --save_interval 200000 --use_db False --lr_anneal_steps=800000"
...
OUTPUT_DIR="/stor/lep/workspace/multi_diffusion/MM-Diffusion/outputs/checkpoints_ablation/my_dfbackbone"
NUM_GPUS=2
WORLD_SIZE=1
NCCL_P2P_DISABLE=1
